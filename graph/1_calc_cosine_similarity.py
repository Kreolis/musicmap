...
np.save(dir_out + "/feature_array_max", feature_array["max"])
np.save(dir_out + "/feature_array_mean", feature_array["mean"])
np.save(dir_out + "/logits_array", logits_array)
...
for key in feature_array:
    ...
    np.save(dir_out + f"/cos_sim_songs_{key}", cos_sim_songs)
